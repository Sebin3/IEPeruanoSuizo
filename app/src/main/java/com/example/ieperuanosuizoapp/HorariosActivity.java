...
public class HorariosActivity extends AppCompatActivity {
    ...
    private void loadCoursesForSelectedDate() {
        ...
        List<Course> courses = getMockCourses(selectedDate);
        ...
        for (int i = 0; i < courses.size(); i++) {
            ...
            ((TextView) itemView.findViewById(R.id.tv_start_time)).setText(course.startTime);
            ((TextView) itemView.findViewById(R.id.tv_end_time)).setText(course.endTime);
            ((TextView) itemView.findViewById(R.id.tv_course_name)).setText(course.name);
            ...
            if ("PROFESOR".equals(userMode)) {
                ...
                ((TextView) itemView.findViewById(R.id.tv_location)).setText(course.location);
                tvPerson.setText(course.section);
                layoutLocation.setVisibility(View.VISIBLE);
            } else {
                // Alumno: Solo ve curso y nombre del profesor
                tvPerson.setText(course.teacher);
                layoutLocation.setVisibility(View.GONE); // Ocultar salón para el alumno
            }
